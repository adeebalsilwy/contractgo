...
return new class extends Migration
{
    ...
    {
        Schema::create('extract_templates', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            ...
            $table->json('default_items')->nullable(); // Default extract items
            $table->string('numbering_pattern')->default('EX-{YEAR}-{SEQUENCE}'); // EX-2026-001
    ...
    {
        Schema::dropIfExists('extract_templates');
    }
};
